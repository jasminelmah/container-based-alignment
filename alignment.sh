...
wget https://github.com/Yale-EEB723/container-based-alignment/raw/master/${SRR}_pass_1.fastq.gz
wget https://github.com/Yale-EEB723/container-based-alignment/raw/master/${SRR}_pass_2.fastq.gz
